...
# If all of the squads in an enemy wave are killed before the duration finishes, 
# the next wave will spawn in approximately 5 seconds.
#############################################################################
...
# Spawns an Enemy wave that lasts for 2 seconds
# A medium group is formed with 1 Elite as the squad leader
# The group spawns on the left side of the map and moves towards the center, then the top-right
# By default, after all waypoints have been reached, the group moves towards the king.
